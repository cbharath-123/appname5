            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      <img src="/avatars/AvatarMale01.png" alt="Natali Craig" className="w-10 h-10 rounded-full" />
                ...
                <tr className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      <img src="/avatars/AvatarMale01.png" alt="Drew Cano" className="w-10 h-10 rounded-full" />
                ...
                <tr className="hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      <img src="/avatars/AvatarFemale06.png" alt="Andi Lane" className="w-10 h-10 rounded-full" />
